...
let TransactionsController = class TransactionsController {
    ...
    createTransaction(user, createTransactionDto) {
        return this.transactionsService.createTransaction(user.id, createTransactionDto.amount, createTransactionDto.type, createTransactionDto.description, new Date(createTransactionDto.date));
    }
