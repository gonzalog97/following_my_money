...
let AchievementsController = class AchievementsController {
    ...
    assignAchievement(user, createAchievementDto) {
        return this.achievementsService.assignAchievementToUser(user.id, createAchievementDto.title, createAchievementDto.description);
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_achievement_dto_1.CreateAchievementDto]),
    __metadata("design:returntype", void 0)
], AchievementsController.prototype, "assignAchievement", null);
